...
- [7. Интеграция с Информационной системой клиента](#7-интеграция-с-информационной-системой-клиента)
...
Основной вариант реализации Центральной платформы MVP выбран в [ADR-005: Критерии выбора основы Центральной платформы MVP](../Task4/ADR-005-solution-selection.md).
...
Представленный С1-С3 диаграммы уже отражают этот подход.
...
- `GET /v1/published-metrics` — получить агрегированные Опубликованные метрики;
- `GET /v1/published-metrics/{metricId}` — получить агрегированную Опубликованную метрику;
