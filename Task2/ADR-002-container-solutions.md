...
4. **[Альтернативный вариант] Существующий IoT-шлюз или TimescaleDB несовместимы с остальной реализацией.**  
...
5. **[Альтернативный вариант] Недостаточная изоляция данных при использовании существующих систем.**  
