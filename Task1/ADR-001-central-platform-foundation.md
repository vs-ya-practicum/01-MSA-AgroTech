...
Требуется сравнить два варианта реализации Центральной платформы. Основной вариант создаёт Центральную платформу с новым Центральным сервисом синхронизации и новым Центральным хранилищем. Центральный сервис синхронизации принимает и проверяет синхронизированные данные, а Управление данными Центральной платформы регистрирует их, сохраняет и управляет их жизненным циклом. В альтернативном варианте Центральная платформа использует и адаптирует Существующий IoT-шлюз и TimescaleDB. Существующий IoT-шлюз предоставляет Центральный сервис синхронизации, а TimescaleDB расширяется данными и схемой свиноводческих ферм. Обе системы остаются внешними для Центральной платформы.
