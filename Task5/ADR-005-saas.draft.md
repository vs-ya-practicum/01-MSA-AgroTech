...
> [!INFO]
> Вторая диаграмма является delta-диаграммой. Она показывает только изменения варианта изоляции на уровне отдельных инстансов; неизменённая часть показана на первой диаграмме.
